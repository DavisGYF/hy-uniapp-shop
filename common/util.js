...
/* const ajaxUrl = env === 'development'
    ? 'http://demo.hanyuan369.com'
    : env === 'production'
        ? 'http://demo.hanyuan369.com': 'http://demo.hanyuan369.com'; */
				
const ApiUrl = 'http://demo.hanyuan369.com/index.php/';
util.ajax_uni= (opt) => {
    opt = opt || {};
    opt.url = opt.url || '';
	...
	console.log('入参数',JSON.stringify(opt.data))
